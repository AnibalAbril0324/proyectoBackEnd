...
a persistence unit "ProyectoParqueaderoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ProyectoParqueadero/pom.xml":
...
artifact ("ProyectoParqueadero.war") is already built. You can build
